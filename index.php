...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  <div class="container-fluid">
   ...
   <div class="container px-4 text-center">
    <div class="row gx-5">
    <div class="col">
     <div class="p-3"><h3>Welcome to Dispatch Guy</h3></div>
	 <div>
	 <img src="img/d.png"/>
	 </div>
   </div>
...
<div class="container">
 <div class="row justify-content-center">
   <div class="card" style="width: 18rem;">
    <img src="img/dr.jpeg" class="card-img-top" alt="...">
    <div class="card-body">
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <p class="card-text">Dispatch Scheduler</p>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img src="img/ss.jpeg" class="card-img-top" alt="...">
  <div class="card-body">
    <p class="card-text">Customer Care Head</p>
  </div>
</div>
 </div>
</div>
